    ...
    return (
        <div
            ...
            <div>
                ...
                <form className="space-y-4 p-10 shadow-2xl rounded-md" onSubmit={handleSubmit}>
                    <div>
                        <label className="text-md font-medium text-gray-300 flex items-center" htmlFor="name">
                            Name
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="text-md font-medium text-gray-300 flex items-center" htmlFor="description">
                            Description
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="text-md font-medium text-gray-300 flex items-center" htmlFor="link">
                            Link
                        </label>
                        <input
                            type="text"
                    ...
                    {currentImage && (
                        <>
                            <label className="text-md font-medium text-gray-300 flex items-center" htmlFor="currentImage">
                                Current Image
                            </label>
                            <img src={`${API_URL}${currentImage}`} alt="Current" name="currentImage" className="w-52" />
                        </>
                    )}
                    <div>
                        <label className="text-md font-medium text-gray-300 flex items-center" htmlFor="image">
                            Image
                        </label>
                        <input
                            type="file"
